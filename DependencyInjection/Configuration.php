    ...
    private function getFontAwesomeNode()
    {
        ...
        $node
            ...
            ->children()
                ->arrayNode('font')
                    ...
                    ->children()
                        ->arrayNode('paths')
                            ...
                            ->prototype('scalar')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/fontawesome/fonts')->end()
                            ->example(array('%kernel.root_dir%/../vendor/bower-asset/fontawesome/fonts', '%kernel.root_dir%/../vendor/foo/bar/fonts'))
                            ->validate()
                                ->ifTrue(function ($v) { return !in_array('%kernel.root_dir%/../vendor/bower-asset/fontawesome/fonts', $v); })
                                ->then(function ($v) {
                                    return array_merge(array('%kernel.root_dir%/../vendor/bower-asset/fontawesome/fonts'), $v);
                                })
                            ->end()
                        ->end()
                    ->end()
                ...
                ->scalarNode('directory')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/fontawesome/less')->end()
                                    ...
                                    ->children()
                                        ->scalarNode('select2')
                                            ...
                                            ->ifTrue(function ($v) { return true === $v; })
                                                ->then(function ($v) { return '%kernel.root_dir%/../vendor/bower-asset/select2/select2.css'; })
                                            ->end()
                                        ->end()
                                        ->scalarNode('select2_bootstrap')
                                            ...
                                            ->beforeNormalization()
                                            ->ifTrue(function ($v) { return true === $v; })
                                                ->then(function ($v) { return '%kernel.root_dir%/../vendor/bower-asset/select2/select2-bootstrap.css'; })
                                            ->end()
                                        ->end()
                                    ->end()
                                ->end()
                ...
                ->arrayNode('javascripts')
                    ...
                    ->children()
                        ->arrayNode('markusslima')
                            ...
                            ->children()
                                ->scalarNode('bootstrap_filestyle')
                                    ->defaultValue('%kernel.root_dir%/../vendor/bower-asset/bootstrap-filestyle/src/bootstrap-filestyle.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/bower-asset/bootstrap-filestyle/src/bootstrap-filestyle.js'; })
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('hammerjs')
                            ...
                            ->children()
                                ->scalarNode('hammer')
                                    ->defaultValue('%kernel.root_dir%/../vendor/npm-asset/hammerjs/hammer.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/npm-asset/hammerjs/hammer.js'; })
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('moment')
                            ...
                            ->children()
                                ->scalarNode('moment')
                                    ->defaultValue('%kernel.root_dir%/../vendor/bower-asset/moment/moment.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/bower-asset/moment/moment.js'; })
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('sonatra_form_extensions')
                            ...
                            ->children()
                                ->scalarNode('select2')
                                    ->defaultValue('%kernel.root_dir%/../vendor/bower-asset/select2/select2.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/bower-asset/select2/select2.js'; })
                                    ->end()
                                ->end()
                                ->scalarNode('knob')
                                    ->defaultValue('%kernel.root_dir%/../vendor/bower-asset/jquery-knob/js/jquery.knob.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/bower-asset/jquery-knob/js/jquery.knob.js'; })
                                    ->end()
                                ->end()
                        ...
                        ->arrayNode('sonatra_gluon')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('footable')
                                    ->defaultValue('%kernel.root_dir%/../vendor/bower-asset/footable/js/footable.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/bower-asset/footable/js/footable.js'; })
                                    ->end()
                                ->end()
