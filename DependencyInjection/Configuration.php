                ...
                ->arrayNode('javascripts')
                    ...
                    ->children()
                        ...
                        ->arrayNode('hammerjs')
                            ...
                            ->children()
                                ->scalarNode('hammer')
                                    ->defaultValue('%kernel.root_dir%/../vendor/sonatra_hammerjs/hammer-js/hammer.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/sonatra_hammerjs/hammer-js/hammer.js'; })
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
