                    ...
                    ->children()
                        ...
                        ->arrayNode('components')
                            ...
                            ->children()
                                ...
                                ->booleanNode('navbar_scroll')->defaultTrue()->end()
                ...
                ->arrayNode('javascripts')
                    ...
                    ->children()
                        ...
                        ->arrayNode('sonatra_gluon')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('navbar_scroll')
                                    ->defaultValue('@SonatraGluonBundle/Resources/assetic/js/navbar-scroll.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '@SonatraGluonBundle/Resources/assetic/js/navbar-scroll.js'; })
                                    ->end()
                                ->end()
                                ->scalarNode('sidebar')
