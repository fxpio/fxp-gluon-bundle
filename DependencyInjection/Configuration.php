        ...
        $node
            ...
            ->children()
                ...
                ->arrayNode('raleway')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->booleanNode('thin')->defaultFalse()->end()
                        ...
                        ->arrayNode('sonatra_form_extensions')
                            ...
                            ->children()
                                ->arrayNode('select2')
                                    ...
                                    ->children()
                                        ->scalarNode('select2')
                                            ->defaultValue('%kernel.root_dir%/../vendor/sonatra_ivaynberg/select2/select2.css')
                                            ->beforeNormalization()
                                            ->ifTrue(function ($v) { return true === $v; })
                ...
                ->arrayNode('javascripts')
                    ...
                    ->children()
                        ...
                        ->arrayNode('rochal')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('jquery_slim_scroll')
                                    ->defaultValue('%kernel.root_dir%/../vendor/sonatra_rochal/jquery-slim-scroll/jquery.slimscroll.js')
                                    ->beforeNormalization()
                                    ->ifTrue(function ($v) { return true === $v; })
                                        ->then(function ($v) { return '%kernel.root_dir%/../vendor/sonatra_rochal/jquery-slim-scroll/jquery.slimscroll.js'; })
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
